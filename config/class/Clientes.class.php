...
class Clientes {
    ...
    public function valida() {
        ...
        }else if(validaDTMaiorTrue($this->dtorigem, date("d/m/Y H:i")) == "0"){
            $this->mensagem["cli_dtnasc"] = "Informe uma data de nascimento válida!";
        }
        if(trim($this->sexo) == "") {
        ...
        }else if(validaEmail($this->email) == "0"){
            $this->mensagem["cli_email"] = "Informe um email valido!";
        }
        if(trim($this->senha) == "") {
